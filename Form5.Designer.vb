...
Partial Class Form5
    ...
    Private Sub InitializeComponent()
        ...
        Guna2Button5.Location = New Point(1818, 77)
        ...
        Guna2HtmlLabel2.Text = "LOOTS AND COLLECTS BOUNTIES OFF OF HIS ENEMIES"
        ' 
        ' Guna2HtmlLabel1
        ' 
        ...
        Guna2HtmlLabel1.Text = "Sneaking invisibly at the heels of his enemies, Bounty Hunter is always keeping track of his foes. Whenever one of his targets falls in battle, he and his allies stand to make quite a profit."
        ' 
        ' Guna2PictureBox7
        ' 
        ...
        Label1.Name = "Label1"
        Label1.Size = New Size(701, 122)
        Label1.TabIndex = 15
        Label1.Text = "Bounty Hunter"
        ' 
        ' Guna2ShadowPanel1
        ' 
